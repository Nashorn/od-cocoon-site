...
export class ExampleFiles {
  static steps = [
    { file: '01-component.html', title: 'From component to Application', label: '01 / COMPONENT', description: 'Start with a component, use its tag on the page. Cocoon discovers, loads and auto-hydrates it automatically. A quick way to bootstrap and prototype ideas.', detail: 'HTML, CSS, JavaScript — plus the page that brings them together.', change: 'The complete setup, including the page that hosts Hello World.', focus: 'index.html' },
    { file: '02-importmap.html', title: 'Give it an address.', label: '02 / IMPORT MAP', description: 'As your application grows, each component needs a stable identifier. Add an .importmap, listing component addresses, so they can be imported later using friendly aliases.', detail: 'The new alias is ready for an explicit import in the next step.', change: 'The page loads .importmap to give your component a readable import name. Hello World itself is unchanged.', focus: '.importmap' },
    { file: '03-application.html', title: 'Make it an application.', label: '03 / APPLICATION', description: 'Your Application now provides the code-behind that powers the simple page we started with. Click Continue to open a sample WelcomePanel. Your Application coordinates & drives the interactions among components.', detail: 'Application orchestration · Two independent components', change: 'HelloApplication opens the new WelcomePanel from Continue. The import map adds its namespace, and page styles move into the Application index.css. Hello World stays unchanged.', focus: 'src/applications/HelloApplication/index.js' },
  ];
